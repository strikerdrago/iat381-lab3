...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
    ...
    React.createElement(Route, {name: "new", handler: NewPage}), 
    /* endinject */
...
},{"./pages/HomePage":250,"./pages/NewPage":251,"material-ui":7,"react":249,"react-router":50,"react-tap-event-plugin":87}],2:[function(require,module,exports){
/*!
  ...
  render: function () {
    return (
      React.createElement("div", {className: "home-page"}, 
        ...
        React.createElement("p", null, "Welcome to this wonderful Material Design. Check out the new page for more content.")
      )
    );
  }
